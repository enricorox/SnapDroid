...
public class SnapDroid extends AppCompatActivity implements SensorEventListener {
	...
	public void onSensorChanged(@NonNull SensorEvent event) {
		// Read an event generated by light sensor
		...
		// Read an event generated by orientation sensor
		...
		// Read an event generated by proximity sensor
	...
	private class HttpChecker extends AsyncTask<Void, Integer, Void> {
		...
		private boolean serviceAvailabilityCheck() {
			try (Socket s = new Socket()) {
				// Connect the socket with a timeout of 1000 milliseconds
